...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents btSettings As System.Windows.Forms.Button
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.pnSettings.Size = New System.Drawing.Size(568, 80)
        Me.pnSettings.TabIndex = 2
        '
        'groupBox1
        '
        Me.groupBox1.Controls.Add(Me.btSettings)
        ...
        'btSettings
        '
        Me.btSettings.BackColor = System.Drawing.SystemColors.Control
        Me.btSettings.Location = New System.Drawing.Point(8, 24)
        Me.btSettings.Name = "btSettings"
        Me.btSettings.Size = New System.Drawing.Size(80, 23)
        Me.btSettings.TabIndex = 12
        Me.btSettings.Text = "Customize"
        '
        'pnDescription
        '
        ...
        Me.laDescription.Text = "This demo shows how to edit SyntaxEdit control settings and save/restore them."
        ...
        Me.syntaxEdit1.Location = New System.Drawing.Point(0, 80)
        Me.syntaxEdit1.Name = "syntaxEdit1"
        Me.syntaxEdit1.Size = New System.Drawing.Size(568, 238)
...
#End Region
    ...
    Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim info As System.IO.FileInfo = New System.IO.FileInfo(dir + "GlobalSettings.xml")
        If info.Exists Then
            syntaxEdit1.SyntaxSettings.LoadFile(dir + "GlobalSettings.xml")
            syntaxEdit1.SyntaxSettings.ApplyToEdit(syntaxEdit1)
        End If
    End Sub

    Private Sub Form1_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        syntaxEdit1.SyntaxSettings.SaveFile(dir + "GlobalSettings.xml")
    End Sub
End Class
