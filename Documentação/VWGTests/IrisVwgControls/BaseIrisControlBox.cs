...
namespace IrisVwgControls
{
  ...
  public class BaseIrisControlBox : Control, IGatewayControl
  {
    ...
    {
      // Create aspx page
      IrisBasePage objASPPage = new IrisBasePage();
      ...
      // Create ascx control
      System.Web.UI.Control objASPControl = this.GetHostedControl(objASPPage);
    ...
    protected virtual void AddCustomAttributes(ref IrisBasePage objASPPage, ref System.Web.UI.WebControls.WebControl objWebControl)
    {      
    }
    ...
    /// </summary>
    /// <returns></returns>
    protected virtual System.Web.UI.Control GetHostedControl(System.Web.UI.Page objASPPage)
    {
    ...
    private void ApplyControlProperties()
    {
      ...
      if (mobjHostedControl != null && this.IsStatelessHostedControl)
      {
        ...
        {
          if (mobjPropertyValues.Contains(objPropertyInfo.Name) && objPropertyInfo.CanWrite)
          {
