...
using Iris.Compression.Encryption;
#endif

using Iris.Compression.Core;
using Iris.Compression.Checksums;
using Iris.Compression.Zip.Compression.Streams;
using Iris.Compression.Zip.Compression;

namespace Iris.Compression.Zip 
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Iris.Compression.Zip.ZipException">
