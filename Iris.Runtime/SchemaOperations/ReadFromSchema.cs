...
namespace Iris.Runtime.Model.Operations.SchemaOperations
{
  ...
  public class ReadFromSchema : BaseSchemaOperation
  {
    ...
    {
      End = -1;
      SetInputs("Schema", "Filename", "Text", "Início", "Término", "Example");
    }
    ...
    protected override IEntity doExecute()
    {
      ...
      ((Operation) schema).Reset();

      if ((GetInput("Example") != null) && (schema is XMLSchema))
      {
        ((XMLSchema)schema).XsdFile = Convert.ToString(GetValue("Example"));
      }
